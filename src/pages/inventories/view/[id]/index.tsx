...
function InventoryViewPage() {
  ...
  const queryParams = useMemo<{ include: { laptop: boolean; company: boolean } }>(
    () =>
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem
                  ...
                  text={data?.last_inventory_check ? format(data?.last_inventory_check, 'dd-MM-yyyy') : ''}
                />
                ...
                {hasAccess('laptop', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Laptop"
                    text={
                      <Link as={NextLink} href={`/laptops/view/${data?.laptop?.id}`}>
                        {data?.laptop?.model + ''}
                      </Link>
                    }
                  />
