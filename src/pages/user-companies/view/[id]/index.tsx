...
import { useUserCompanyFindFirst, useRoqClient } from 'lib/roq';

import { UserCompanyInterface } from 'interfaces/user-company';

function UserCompanyViewPage() {
  ...
  const { data, error, isLoading } = useUserCompanyFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('user_company', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/user-companies/edit/${id}`} passHref legacyBehavior>
                    <Button
