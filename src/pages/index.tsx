...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`laptop inventory management app`}</title>

        <meta
          name="description"
          content="Effortlessly Manage Your Assets with Laptop Inventory Management App: Streamlining Your Laptop Inventory Needs in a Seamless, User-Friendly Interface"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxsYXB0b3B8ZW58MHx8fHwxNjk5MDc1ODA3fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Effortlessly Manage Your Assets with Laptop Inventory Management App: Streamlining Your Laptop Inventory Needs in a Seamless, User-Friendly Interface`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                ...
                <Card userTypeName="End User" type="end-user" abilities={appConfig.customerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
