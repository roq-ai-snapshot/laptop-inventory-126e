...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: [, 'inventory.count', 'user_company.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('inventory', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('user_company', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'user_company',
          header: 'User Company',
          accessorKey: 'user_company',
          cell: ({ row: { original: record } }: any) => record?._count?.user_company,
        }
      : null,
