...
function LaptopCreatePage() {
  ...
  const formik = useFormik<LaptopInterface>({
    initialValues: {
      ...
      warranty_expiration: new Date(new Date().toDateString()),
      status: '',
    },
    ...
    >
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <FormControl id="warranty_expiration" mb="4">
            <FormLabel fontSize="1rem" fontWeight={600}>
              Warranty Expiration
            </FormLabel>
            <DatePicker
              selected={formik.values?.warranty_expiration ? new Date(formik.values?.warranty_expiration) : null}
              onChange={(value: Date) => formik.setFieldValue('warranty_expiration', value)}
            />
          </FormControl>
