...
export function useLaptopFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useLaptopFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.laptop.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useLaptopCount<T extends Prisma.laptopCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.laptopCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useLaptopCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.laptop.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useLaptopFindManyWithCount<
  T extends Prisma.laptopFindManyArgs,
  R extends { data: GetFindResult<Prisma.$laptopPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.laptopFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useLaptopFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.laptop.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useLaptopFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useLaptopFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.laptop.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useUserCompanyFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useUserCompanyFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.user_company.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useUserCompanyCount<T extends Prisma.user_companyCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.user_companyCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useUserCompanyCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.user_company.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useUserCompanyFindManyWithCount<
  T extends Prisma.user_companyFindManyArgs,
  R extends { data: GetFindResult<Prisma.$user_companyPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.user_companyFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useUserCompanyFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.user_company.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useUserCompanyFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useUserCompanyFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.user_company.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
