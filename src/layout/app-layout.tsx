...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['inventory-manager', 'owner', 'it-administrator', 'finance-manager'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Laptops', path: '/laptops', entity: 'laptop', service: AccessServiceEnum.PROJECT, icon: FiBox },
    {
      name: 'Transactions',
      path: '/transactions',
      entity: 'transaction',
