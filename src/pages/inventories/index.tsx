...
export function InventoryListPage(props: InventoryListPageProps) {
  ...
  const columns: ColumnType[] = [
    ...
    {
      id: 'last_inventory_check',
      header: 'Last Inventory Check',
      accessorKey: 'last_inventory_check',
      cell: ({ row: { original: record } }: any) =>
        record?.last_inventory_check ? format(record?.last_inventory_check, 'dd-MM-yyyy') : '',
    },
